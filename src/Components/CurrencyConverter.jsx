...
const CurrencyConverter = () => {
    ...
    const API_KEY = process.env.REACT_APP_EXCHANGERATES_API_KEY || 'ZEOcbrQz5MhCJ7U7O5hlwaTrjICVjjtU'; // Replace with your actual API key
    
    useEffect(() => {
        const fetchConversionRate = async () => {
            try {
                console.log(`Using API Key: ${API_KEY}`); // Debugging statement
